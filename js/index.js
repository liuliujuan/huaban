$(function(){
	...
	$('.new').click(function(){
		...
		$('#xinjian button').first().off();
		$('#xinjian').animate({marginTop:-100},1000,function(){
			$('#xinjian button').last().click(function(){
				$('#xinjian').animate({marginTop:-600},1000);
			})
			$('#xinjian button').first().click(function(){
				if($('#xinjian input:first').val()==''||$('.xinjian input:last').val()==''){
					alert('请输入要求的值');
					return;
				}
				w=$('#xinjian input:first').val();
				h=$('#xinjian input:last').val();
				$('#xinjian').animate({marginTop:-600},1000,function(){
